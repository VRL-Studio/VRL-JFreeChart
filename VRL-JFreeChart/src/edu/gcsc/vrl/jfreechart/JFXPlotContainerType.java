 ...
 */
@TypeInfo(type = JFreeChart.class, input = false, output = true, style = "default")
public class JFXPlotContainerType extends TypeRepresentationBase implements java.io.Serializable {
...
//   
    ...
    public void setViewValue(Object o) {
        ...
        if (o instanceof JFreeChart) {
            ...
            final JFreeChart chart = (JFreeChart) o;

            updateChartPanel(chartContainer, chart);
